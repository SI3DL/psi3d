...
!------------------------------------------------------------
  ...
  !. . . Read model rates
  READ (UNIT=i99,FMT='(///(14X,G20.2))',IOSTAT=ios)  mu_max1, R_mor1, R_gr1,  &
  ...
  READ (UNIT=i99,FMT='(///(14X,G20.2))',IOSTAT=ios) Topt1, Topt2, Topt3, Topt4, Topt5, &
  ...
  READ (UNIT=i99,FMT='(///(14X,G20.2))',IOSTAT=ios) R_SOD, ATM_DON, ATM_NH4,    &
